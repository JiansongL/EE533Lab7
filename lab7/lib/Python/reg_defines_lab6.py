...
def DEVICE_PROJ_NAME ():
    return "Pipelined_Processor"

def DEVICE_PROJ_DESC ():
    return "Pipelined Processor"
...
def PIPELINE_PROCESSOR_BASE_ADDR (): 
    return 0x2000100
...
def PIPELINE_PROCESSOR_REG_DMEM_DATA_LO_REG (): 
    return 0x2000100

def PIPELINE_PROCESSOR_REG_DMEM_DATA_HI_REG (): 
    return 0x2000104

def PIPELINE_PROCESSOR_REG_DMEM_ADDR_REG ():    
    return 0x2000108

def PIPELINE_PROCESSOR_REG_IMEM_ADDR_REG ():    
    return 0x200010c

def PIPELINE_PROCESSOR_REG_PIPELINE_C_REG ():   
    return 0x2000110

def PIPELINE_PROCESSOR_REG_PROC_RESET_REG ():   
    return 0x2000114

def PIPELINE_PROCESSOR_REG_IMEM_OUT_REG ():     
    return 0x2000118
...
__main__.nf_regmap.update({
    ...
    0x2000100 : "PIPELINE_PROCESSOR_REG_DMEM_DATA_LO_REG",
    0x2000104 : "PIPELINE_PROCESSOR_REG_DMEM_DATA_HI_REG",
    0x2000108 : "PIPELINE_PROCESSOR_REG_DMEM_ADDR_REG",
    0x200010c : "PIPELINE_PROCESSOR_REG_IMEM_ADDR_REG",
    0x2000110 : "PIPELINE_PROCESSOR_REG_PIPELINE_C_REG",
    0x2000114 : "PIPELINE_PROCESSOR_REG_PROC_RESET_REG",
    0x2000118 : "PIPELINE_PROCESSOR_REG_IMEM_OUT_REG",

    0x2000200 : "ROUTER_OP_LUT_ARP_NUM_MISSES_REG",
    0x2000204 : "ROUTER_OP_LUT_LPM_NUM_MISSES_REG",
    0x2000208 : "ROUTER_OP_LUT_NUM_CPU_PKTS_SENT_REG",
    0x200020c : "ROUTER_OP_LUT_NUM_BAD_OPTS_VER_REG",
    0x2000210 : "ROUTER_OP_LUT_NUM_BAD_CHKSUMS_REG",
    0x2000214 : "ROUTER_OP_LUT_NUM_BAD_TTLS_REG",
    0x2000218 : "ROUTER_OP_LUT_NUM_NON_IP_RCVD_REG",
    0x200021c : "ROUTER_OP_LUT_NUM_PKTS_FORWARDED_REG",
    0x2000220 : "ROUTER_OP_LUT_NUM_WRONG_DEST_REG",
    0x2000224 : "ROUTER_OP_LUT_NUM_FILTERED_PKTS_REG",
    0x2000228 : "ROUTER_OP_LUT_MAC_0_HI_REG",
    0x200022c : "ROUTER_OP_LUT_MAC_0_LO_REG",
    0x2000230 : "ROUTER_OP_LUT_MAC_1_HI_REG",
    0x2000234 : "ROUTER_OP_LUT_MAC_1_LO_REG",
    0x2000238 : "ROUTER_OP_LUT_MAC_2_HI_REG",
    0x200023c : "ROUTER_OP_LUT_MAC_2_LO_REG",
    0x2000240 : "ROUTER_OP_LUT_MAC_3_HI_REG",
    0x2000244 : "ROUTER_OP_LUT_MAC_3_LO_REG",
    0x2000248 : "ROUTER_OP_LUT_ROUTE_TABLE_ENTRY_IP_REG",
    0x200024c : "ROUTER_OP_LUT_ROUTE_TABLE_ENTRY_MASK_REG",
    0x2000250 : "ROUTER_OP_LUT_ROUTE_TABLE_ENTRY_NEXT_HOP_IP_REG",
    0x2000254 : "ROUTER_OP_LUT_ROUTE_TABLE_ENTRY_OUTPUT_PORT_REG",
    0x2000258 : "ROUTER_OP_LUT_ROUTE_TABLE_RD_ADDR_REG",
    0x200025c : "ROUTER_OP_LUT_ROUTE_TABLE_WR_ADDR_REG",
    0x2000260 : "ROUTER_OP_LUT_ARP_TABLE_ENTRY_MAC_HI_REG",
    0x2000264 : "ROUTER_OP_LUT_ARP_TABLE_ENTRY_MAC_LO_REG",
    0x2000268 : "ROUTER_OP_LUT_ARP_TABLE_ENTRY_NEXT_HOP_IP_REG",
    0x200026c : "ROUTER_OP_LUT_ARP_TABLE_RD_ADDR_REG",
    0x2000270 : "ROUTER_OP_LUT_ARP_TABLE_WR_ADDR_REG",
    0x2000274 : "ROUTER_OP_LUT_DST_IP_FILTER_TABLE_ENTRY_IP_REG",
    0x2000278 : "ROUTER_OP_LUT_DST_IP_FILTER_TABLE_RD_ADDR_REG",
    0x200027c : "ROUTER_OP_LUT_DST_IP_FILTER_TABLE_WR_ADDR_REG",
