...
#
# Project: Pipelined_Processor (lab6)
# Description: Pipelined Processor
#
#############################################################

package reg_defines_lab6;
...
@EXPORT = qw(
                ...
                IN_ARB_STATE_REG
                PIPELINE_PROCESSOR_REG_DMEM_DATA_LO_REG
                PIPELINE_PROCESSOR_REG_DMEM_DATA_HI_REG
                PIPELINE_PROCESSOR_REG_DMEM_ADDR_REG
                PIPELINE_PROCESSOR_REG_IMEM_ADDR_REG
                PIPELINE_PROCESSOR_REG_PIPELINE_C_REG
                PIPELINE_PROCESSOR_REG_PROC_RESET_REG
                PIPELINE_PROCESSOR_REG_IMEM_OUT_REG
...
sub DEVICE_PROJ_DIR ()  { "lab6"; }
sub DEVICE_PROJ_NAME () { "Pipelined_Processor"; }
sub DEVICE_PROJ_DESC () { "Pipelined Processor"; }
...
sub PIPELINE_PROCESSOR_BASE_ADDR ()   { 0x2000100; }
sub ROUTER_OP_LUT_BASE_ADDR ()        { 0x2000200; }
...
# Name: pipeline_processor (PIPELINE_PROCESSOR)
# Description: Registers for Pipeline
# File: projects/lab6/include/pipeline_processor.xml
sub PIPELINE_PROCESSOR_REG_DMEM_DATA_LO_REG ()   { 0x2000100;}
sub PIPELINE_PROCESSOR_REG_DMEM_DATA_HI_REG ()   { 0x2000104;}
sub PIPELINE_PROCESSOR_REG_DMEM_ADDR_REG ()      { 0x2000108;}
sub PIPELINE_PROCESSOR_REG_IMEM_ADDR_REG ()      { 0x200010c;}
sub PIPELINE_PROCESSOR_REG_PIPELINE_C_REG ()     { 0x2000110;}
sub PIPELINE_PROCESSOR_REG_PROC_RESET_REG ()     { 0x2000114;}
sub PIPELINE_PROCESSOR_REG_IMEM_OUT_REG ()       { 0x2000118;}

# Name: router_op_lut (ROUTER_OP_LUT)
# Description: Output port lookup for IPv4 router (CAM based)
# File: lib/verilog/core/output_port_lookup/cam_router/xml/cam_router.xml
sub ROUTER_OP_LUT_ARP_NUM_MISSES_REG ()                  { 0x2000200;}
sub ROUTER_OP_LUT_LPM_NUM_MISSES_REG ()                  { 0x2000204;}
sub ROUTER_OP_LUT_NUM_CPU_PKTS_SENT_REG ()               { 0x2000208;}
sub ROUTER_OP_LUT_NUM_BAD_OPTS_VER_REG ()                { 0x200020c;}
sub ROUTER_OP_LUT_NUM_BAD_CHKSUMS_REG ()                 { 0x2000210;}
sub ROUTER_OP_LUT_NUM_BAD_TTLS_REG ()                    { 0x2000214;}
sub ROUTER_OP_LUT_NUM_NON_IP_RCVD_REG ()                 { 0x2000218;}
sub ROUTER_OP_LUT_NUM_PKTS_FORWARDED_REG ()              { 0x200021c;}
sub ROUTER_OP_LUT_NUM_WRONG_DEST_REG ()                  { 0x2000220;}
sub ROUTER_OP_LUT_NUM_FILTERED_PKTS_REG ()               { 0x2000224;}
sub ROUTER_OP_LUT_MAC_0_HI_REG ()                        { 0x2000228;}
sub ROUTER_OP_LUT_MAC_0_LO_REG ()                        { 0x200022c;}
sub ROUTER_OP_LUT_MAC_1_HI_REG ()                        { 0x2000230;}
sub ROUTER_OP_LUT_MAC_1_LO_REG ()                        { 0x2000234;}
sub ROUTER_OP_LUT_MAC_2_HI_REG ()                        { 0x2000238;}
sub ROUTER_OP_LUT_MAC_2_LO_REG ()                        { 0x200023c;}
sub ROUTER_OP_LUT_MAC_3_HI_REG ()                        { 0x2000240;}
sub ROUTER_OP_LUT_MAC_3_LO_REG ()                        { 0x2000244;}
sub ROUTER_OP_LUT_ROUTE_TABLE_ENTRY_IP_REG ()            { 0x2000248;}
sub ROUTER_OP_LUT_ROUTE_TABLE_ENTRY_MASK_REG ()          { 0x200024c;}
sub ROUTER_OP_LUT_ROUTE_TABLE_ENTRY_NEXT_HOP_IP_REG ()   { 0x2000250;}
sub ROUTER_OP_LUT_ROUTE_TABLE_ENTRY_OUTPUT_PORT_REG ()   { 0x2000254;}
sub ROUTER_OP_LUT_ROUTE_TABLE_RD_ADDR_REG ()             { 0x2000258;}
sub ROUTER_OP_LUT_ROUTE_TABLE_WR_ADDR_REG ()             { 0x200025c;}
sub ROUTER_OP_LUT_ARP_TABLE_ENTRY_MAC_HI_REG ()          { 0x2000260;}
sub ROUTER_OP_LUT_ARP_TABLE_ENTRY_MAC_LO_REG ()          { 0x2000264;}
sub ROUTER_OP_LUT_ARP_TABLE_ENTRY_NEXT_HOP_IP_REG ()     { 0x2000268;}
sub ROUTER_OP_LUT_ARP_TABLE_RD_ADDR_REG ()               { 0x200026c;}
sub ROUTER_OP_LUT_ARP_TABLE_WR_ADDR_REG ()               { 0x2000270;}
sub ROUTER_OP_LUT_DST_IP_FILTER_TABLE_ENTRY_IP_REG ()    { 0x2000274;}
sub ROUTER_OP_LUT_DST_IP_FILTER_TABLE_RD_ADDR_REG ()     { 0x2000278;}
sub ROUTER_OP_LUT_DST_IP_FILTER_TABLE_WR_ADDR_REG ()     { 0x200027c;}
